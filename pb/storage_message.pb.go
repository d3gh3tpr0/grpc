...
type Storage struct {
	...
	Driver Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=hieupt.pcbook.Storage_Driver" json:"driver,omitempty"`
...
var file_proto_storage_message_proto_rawDesc = []byte{
	...
	,
...
var file_proto_storage_message_proto_goTypes = []interface{}{
	(Storage_Driver)(0), // 0: hieupt.pcbook.Storage.Driver
	(*Storage)(nil),     // 1: hieupt.pcbook.Storage
	(*Memory)(nil),      // 2: hieupt.pcbook.Memory
}
var file_proto_storage_message_proto_depIdxs = []int32{
	0, // 0: hieupt.pcbook.Storage.driver:type_name -> hieupt.pcbook.Storage.Driver
	2, // 1: hieupt.pcbook.Storage.memory:type_name -> hieupt.pcbook.Memory
